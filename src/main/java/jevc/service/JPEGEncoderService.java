...
public class JPEGEncoderService {
    ...
    private final YCbCrImage image;
    ...
    public void compress() throws IOException {
        ...
        internalFrameBuffer.dumpBufferToStream(outputStream);
    ...
    private void writeSOF0Segment(BufferedOutputStream outputStream) throws IOException {
        ...
        YCbCrImage.computeSamplingFactors(image.getSampling(), horizSamplingFactors, vertSamplingFactors);
        int index = 10;
